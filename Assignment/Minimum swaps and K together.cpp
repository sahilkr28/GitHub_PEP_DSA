...
// i.e choose any two index i and j (i < j) and swap arr[i] , arr[j] . Find the minimum number of swaps 
...
// Output: 1
// Explanation: To bring elements 2, 1, 3 together, swap index 2 with 4 (0-based indexing), i.e. element 
// arr[2] = 5 with arr[4] = 3 such that final array will be- arr[] = [2, 1, 3, 6, 5]
// Input: arr[] = [2, 7, 9, 5, 8, 7, 4], k = 6 
// Output: 2 
// Explanation: To bring elements 2, 5, 4 together, swap index 0 with 2 (0-based indexing) and 
